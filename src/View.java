  ...
  static void display(CalendarList feed) {
    if (feed.getItems() != null) {
      for (CalendarListEntry entry : feed.getItems()) {
        System.out.println();
        System.out.println("-----------------------------------------------");
        System.out.println("getBackgroundColor="+entry.getBackgroundColor());
        System.out.println("getColorId="+entry.getColorId());
        System.out.println("getForegroundColor="+entry.getForegroundColor());
        display(entry);
      }
    }
  }
